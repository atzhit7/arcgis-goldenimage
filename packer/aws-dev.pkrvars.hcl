...
ansible_playbooks = {
  "arcgisserver_playbook_file"  = "../ansible/dev_arcgisserver.yaml"
  "arcgisportal_playbook_file"  = "../ansible/dev_arcgisportal.yaml"
  "arcgisdatastore_playbook_file"  = "../ansible/dev_arcgisdatastore.yaml"
}
